;################################################################################
;#	Título: Librerias varias								 					#
;#																				#
;#	Versión:		1.1									Fecha: 	09/05/2013		#
...
;#		1.1 | 09/05/2013 | D.GARCIA | Agregado de funciones de 64 bits			#
;#																				#
;################################################################################

;********************************************************************************
; Simbolos globales y externos
;********************************************************************************
GLOBAL RTC_Service

;********************************************************************************
; Funciones de 32 bits
;********************************************************************************
USE32
SECTION		.library	
;--------------------------------------------------------------------------------
...
;################################################################################
;# Diego Garcia					- -- Fin de Archivo -- -			    c2010 	#
;################################################################################